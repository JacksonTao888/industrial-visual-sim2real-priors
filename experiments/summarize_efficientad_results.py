#!/usr/bin/env python3
"""Summarize per-category EfficientAD metrics written by run_efficientad_anomalib.py."""
...
def main() -> None:
    ...
    result_dir = args.result_dir or (
        args.project_root / "experiments" / "runs" / "no_cad" / "efficientad" / args.dataset
    )
    csv_path = args.csv or result_dir / "efficientad_results.csv"
    summary_path = args.summary or result_dir / "efficientad_results.summary.json"
