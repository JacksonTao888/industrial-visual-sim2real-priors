#!/usr/bin/env python3
"""Run PatchCore no-CAD anomaly baselines with anomalib."""
...
def main() -> None:
    ...
    out_root = args.out_root or project_root / "experiments" / "runs" / "no_cad" / "patchcore"
    ...
    csv_path = result_dir / "patchcore_results.csv"
    summary_path = result_dir / "patchcore_results.summary.json"
